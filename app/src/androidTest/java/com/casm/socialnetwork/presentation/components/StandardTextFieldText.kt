package com.casm.socialnetwork.presentation.components
...
import com.casm.socialnetwork.core.util.TestTags.PASSWORD_TOGGLE
import com.casm.socialnetwork.core.util.TestTags.STANDARD_TEXT_FIELD
import org.junit.Rule
import org.junit.Test
import org.junit.runner.RunWith

@RunWith(AndroidJUnit4::class)
class StandardTextFieldText {
        ...
        composeTestRule.activity.setContent {
            ...
            MaterialTheme {
                StandardTextField(
                    ...
                    maxLength = 5,
                    modifier = Modifier.semantics { testTag = STANDARD_TEXT_FIELD }
                )
            }
        }
